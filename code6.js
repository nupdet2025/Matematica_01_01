...
gdjs.FinalCode.GDopcaoObjects1= [];
gdjs.FinalCode.GDopcaoObjects2= [];
...
gdjs.FinalCode.GDFogoObjects1= [];
gdjs.FinalCode.GDFogoObjects2= [];
gdjs.FinalCode.GDFumacaObjects1= [];
gdjs.FinalCode.GDFumacaObjects2= [];


gdjs.FinalCode.asyncCallback15400684 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.FinalCode.asyncCallback15400684(runtimeScene, asyncObjectsList)));
}
}
...
}{gdjs.evtTools.sound.playSoundOnChannel(runtimeScene, "assets\\audio_final.mp3", 3, false, 100, 1);
}}
...
gdjs.FinalCode.GDopcaoObjects1.length = 0;
gdjs.FinalCode.GDopcaoObjects2.length = 0;
...
gdjs.FinalCode.GDFogoObjects1.length = 0;
gdjs.FinalCode.GDFogoObjects2.length = 0;
gdjs.FinalCode.GDFumacaObjects1.length = 0;
gdjs.FinalCode.GDFumacaObjects2.length = 0;
