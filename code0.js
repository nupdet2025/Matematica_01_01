...
gdjs.IntroCode.GDbtn_9595comecarObjects1= [];
gdjs.IntroCode.GDbtn_9595comecarObjects2= [];
...
gdjs.IntroCode.GDFogoObjects1= [];
gdjs.IntroCode.GDFogoObjects2= [];
gdjs.IntroCode.GDFumacaObjects1= [];
gdjs.IntroCode.GDFumacaObjects2= [];


gdjs.IntroCode.asyncCallback12793340 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.IntroCode.asyncCallback12793340(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.copyArray(runtimeScene.getObjects("btn_comecar"), gdjs.IntroCode.GDbtn_9595comecarObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.IntroCode.GDbtn_9595comecarObjects1.length;i<l;++i) {
    if ( gdjs.IntroCode.GDbtn_9595comecarObjects1[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.IntroCode.GDbtn_9595comecarObjects1[k] = gdjs.IntroCode.GDbtn_9595comecarObjects1[i];
        ++k;
    }
}
gdjs.IntroCode.GDbtn_9595comecarObjects1.length = k;
if (isConditionTrue_0) {
...
gdjs.IntroCode.GDbtn_9595comecarObjects1.length = 0;
gdjs.IntroCode.GDbtn_9595comecarObjects2.length = 0;
...
gdjs.IntroCode.GDFogoObjects1.length = 0;
gdjs.IntroCode.GDFogoObjects2.length = 0;
gdjs.IntroCode.GDFumacaObjects1.length = 0;
gdjs.IntroCode.GDFumacaObjects2.length = 0;
